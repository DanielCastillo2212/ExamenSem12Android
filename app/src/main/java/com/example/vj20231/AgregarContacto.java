...
public class AgregarContacto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAgregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!nombre.isEmpty()) {
                    // Crear un nuevo objeto Contact con el nombre ingresado
    ...
    private void agregarContactoConImagen(String imageUrl) {
        ...
        if (!nombre.isEmpty()) {
            // Crear un nuevo objeto Contact con el nombre ingresado y la URL de la imagen
            Contact contact = new Contact();
            contact.setNameContact(nombre);
            contact.setImgContact("https://demo-upn.bit2bittest.com/"+imageUrl);
            ...
            createCall.enqueue(new Callback<Contact>() {
                ...
                public void onResponse(Call<Contact> call, Response<Contact> response) {
                    if (response.isSuccessful()) {
                        Toast.makeText(AgregarContacto.this, "Publicacion agregado correctamente", Toast.LENGTH_SHORT).show();
                        finish(); // Cerrar la actividad después de agregar el contacto
                    } else {
                        Toast.makeText(AgregarContacto.this, "Error al agregar la publicacion", Toast.LENGTH_SHORT).show();
                    }
                }
            ...
            Toast.makeText(AgregarContacto.this, "Ingrese un nombre válido", Toast.LENGTH_SHORT).show();
        }
    }
}
